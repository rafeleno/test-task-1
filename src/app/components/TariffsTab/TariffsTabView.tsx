...
export const TariffsTabView = ({
  ...
  return (
    <div
      onClick={onClick}
      className={
        `${isVertical ? "col-span-full pt-[30]" : "pt-[70]"} rounded-[40] border-[2] border-[#484D4E] bg-[#313637] cursor-pointer relative` +
        " " +
      ...
      data-id={id}
    >
      {salePercent && <div className={styles.salePercentTab + " " + roboto.className}>-{salePercent}%</div>}
      <div className={`${isVertical ? "flex-row max-w-[546]" : "flex-col max-w-[204]"} flex m-auto gap-[40]`}>
        <div className={`${isVertical ? "pl-[40]" + " " : ""}text-nowrap`}>
          ...
          <p className={`mb-0 text-5xl font-[600] place-self-center` + " " + (isActive ? "text-[#fdb056]" : "")}>{priceAfterSale} ₽</p>
